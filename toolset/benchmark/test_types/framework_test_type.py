    ...
    def get_current_world_table(self):
        ...
        if database_name == "mysql":
            ...
            try:
                ...
                tb = traceback.format_exc()
                log(
                    "ERROR: Unable to load current Postgres World table.",
                    color=Fore.RED,
                )
                log(tb)
            ...
            try:
                ...
                connection = pymongo.MongoClient(host=self.config.database_host)
                ...
                tb = traceback.format_exc()
                log(
                    "ERROR: Unable to load current MongoDB World table.", color=Fore.RED
                )
                log(tb)
        else:
